    ...
    >
      <div className="mx-auto max-w-[1400px] grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-24 px-6 sm:px-10 md:px-16 pt-28 md:pt-32 pb-16 md:pb-24 lg:min-h-screen">
        ...
        <motion.div
          ...
          className="flex flex-col gap-[8px] items-center lg:items-start text-black max-w-[540px] mx-auto lg:mx-0 lg:pl-8 xl:pl-16 text-center lg:text-left -mt-6 md:-mt-32"
        >
          <h1
