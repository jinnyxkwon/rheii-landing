...
export default function HeroSection() {
  return (
    ...
    >
      <div className="mx-auto max-w-[1400px] grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-24 px-6 sm:px-10 md:px-16 pt-12 md:pt-16 pb-16 md:pb-24 lg:min-h-screen">
        {/* Headline */}
        <motion.div
