 ...
 *
 * Upcoming IRL events. Mono eyebrow + DM Sans headline, then a two-column
 * editorial block: a hairline-framed event image beside serif prose and a
 * clay accent link out to the ticket page.
 */
  ...
  return (
    <section className="w-full bg-parchment pt-[128px] pb-[40px] md:pt-[160px] px-5 sm:px-8 md:px-[104px]">
      <motion.div variants={staggerParent(0.1)} {...inViewProps} className="max-w-page mx-auto">
        <motion.p variants={fadeUp} className="eyebrow mb-[16px]">
          Upcoming events
        </motion.p>
        <motion.h2
          variants={fadeUp}
        ...
        >
          Join us{' '}
          <span className="font-editorial italic font-medium text-clay">IRL</span> this July
        </motion.h2>
        ...
        >
          <div className="relative w-full sm:w-[380px] shrink-0 rounded-[16px] overflow-hidden border border-stone aspect-[4/5]">
            <Image
          ...
          <div className="flex flex-col gap-4 pt-1 max-w-[540px]">
            ...
            <div className="font-editorial text-[19px] leading-[1.55] text-ink/85 space-y-4">
              ...
              <p>
                Whether you&apos;re navigating a change, managing stress, or seeking peace amidst the
                daily noise of your own expectations, the real challenge isn&apos;t finding a static
                calm — it&apos;s learning how to stay anchored while you&apos;re in motion.
              </p>
              <p>
